...
Section~\ref{sec:exp_comparison} compares LIQCA with the baselines under several experimental settings.
...
We conducted experiments on both public and private sewer datasets.

\paragraph{Public dataset.}
We use \textbf{Sewer-ML} as the public sewer dataset.
...
The original video resolutions in Sewer-ML vary widely and are primarily distributed across
$350 \times 284$, $352 \times 288$, $466 \times 568$, $480 \times 576$, $720 \times 576$, and $768 \times 576$.

Figure~\ref{fig:sewer_ml_samples} shows normal and abnormal examples from Sewer-ML.
